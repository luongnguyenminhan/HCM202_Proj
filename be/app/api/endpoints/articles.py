...
async def get_article_detail(article_id: int, article_service: ArticleService = Depends(get_article_service)):
    """
    ...
    try:
        ...
        raise HTTPException(status_code=500, detail=f'Failed to get article detail: {str(e)}')
...
async def get_featured_articles(
    ...
    try:
        ...
        raise HTTPException(status_code=500, detail=f'Failed to get featured articles: {str(e)}')
